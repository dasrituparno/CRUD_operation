...
// //   const token = req.cookies.token;
// //   if (token) {
// //     // If token exists, continue to the next middleware
// //     next();
// //   } else {
...
// //   try {
// //     const { product_name, product_description } = req.body;
// //     const productImage = req.file; // Uploaded image file

// //     await productsModel.createProductTable(); // Wait for product table creation

// //     // Handle product data insertion here, including image upload
// //     await productsModel.insertProductWithImage(product_name, product_description, productImage);
...
//     const updatedProduct = await productsModel.updateProduct(id, product_name, product_description); // Wait for product data update
